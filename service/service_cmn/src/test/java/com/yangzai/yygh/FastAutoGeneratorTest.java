...
public class FastAutoGeneratorTest {
    ...
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create("jdbc:mysql://127.0.0.1:3306/yygh_cmn?" +
                "serverTimezone=GMT%2B8&characterEncoding=utf-8&useSSL=false", "root", "123456")
                .globalConfig(builder -> {
                    builder.author("yangzai") // 设置作者
//.enableSwagger() // 开启 swagger 模式
                            .fileOverride() // 覆盖已生成文件
                            .outputDir("D:\\IdeaProjects\\Hospital\\yygh_parent\\service\\service_cmn\\src\\main\\java"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.yangzai") // 设置父包名
                            .moduleName("yygh") // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml,
                                    "D:\\IdeaProjects\\Hospital\\yygh_parent\\service\\service_cmn\\src\\main\\resources\\mapper"));
// 设置mapperXml生成路径
                })
